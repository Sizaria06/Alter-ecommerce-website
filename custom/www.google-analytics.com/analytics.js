(function() {
    ...
    */
    ...
    var u = window,
        ...
        y = navigator,
        z = function(a, b) {
            w.addEventListener ? w.addEventListener(a, b, !1) : w.attachEvent && w.attachEvent("on" + a, b)
        };
    var A = {},
        B = function(a) {
            A.TAGGING = A.TAGGING || [];
    ...
    var C = /:[0-9]+$/,
        F = function(a, b) {
            ...
            if ("protocol" === b || "port" === b) a.protocol = D(a.protocol) || D(u.location.protocol);
            "port" === b ? a.port = String(Number(a.hostname ? a.port : u.location.port) || ("http" === a.protocol ? 80 : "https" === a.protocol ? 443 : "")) : "host" === b && (a.hostname = (a.hostname || u.location.hostname).replace(C, "").toLowerCase());
            return E(a, b)
        },
        E = function(a, b, c) {
            var d = D(a.protocol);
    ...
    function R(a, b) {
        a = [u.navigator.userAgent, (new Date).getTimezoneOffset(), y.userLanguage || y.language, Math.floor((new Date(Date.now())).getTime() / 60 / 1E3) - (void 0 === b ? 0 : b), a].join("*");
        if (!(b = L)) {
            b = Array(256);
            for (var c = 0; 256 > c; c++) {
    ...
    function ja(a, b, c) {
        ...
        if (v && v.replaceState) {
            var e = Q("_gl");
            if (e.test(b) || e.test(c)) a = F(a, "path"), b = d(b, "?"), c = d(c, "#"), v.replaceState({}, void 0, "" + a + b + c)
        }
    }
    var T = function(a) {
        try {
    ...
    function X(a, b, c) {
        if (c && c.action) {
            ...
            if ("get" === d) {
                ...
                e || (d = w.createElement("input"), d.setAttribute("type", "hidden"), d.setAttribute("name", a), d.setAttribute("value", b), c.appendChild(d))
