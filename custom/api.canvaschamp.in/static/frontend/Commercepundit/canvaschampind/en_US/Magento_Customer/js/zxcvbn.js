...
(function(f) {
    ...
    return (function e(t, n, r) {
        ...
        3: [function(require, module, exports) {
            var frequency_lists;
            frequency_lists = {}, module.exports = frequency_lists;
        ...
        5: [function(require, module, exports) {
            ...
            GRAPHS = {
            ...
            }, DATE_MAX_YEAR = 2050, DATE_MIN_YEAR = 1e3, DATE_SPLITS = {
                4: [
                    [1, 2],
                    [2, 3]
                ],
                ...
                dictionary_match: function(e, t) {
                    ...
                    for (n in t)
                        for (l = t[n], r = o = 0, _ = a; _ >= 0 ? _ > o : o > _; r = _ >= 0 ? ++o : --o)
                            for (i = h = f = r, d = a; d >= f ? d > h : h > d; i = d >= f ? ++h : --h) c.slice(r, +i + 1 || 9e9) in l && (g = c.slice(r, +i + 1 || 9e9), u = l[g], s.push({
                                pattern: "dictionary",
                                i: r,
                                j: i,
                ...
                enumerate_l33t_subs: function(e) {
                    ...
                    a = function() {
                        ...
                        if (t.length) {
                            for (a = t[0], E = t.slice(1), u = [], d = e[a], l = 0, h = d.length; h > l; l++)
                                for (o = d[l], _ = 0, c = g.length; c > _; _++) {
                                    for (m = g[_], i = -1, s = f = 0, p = m.length; p >= 0 ? p > f : f > p; s = p >= 0 ? ++f : --f)
                                        if (m[s][0] === o) {
                                            i = s;
                                            break
                                        } -
                                    1 === i ? (A = m.concat([
                                        [o, a]
                                    ]), u.push(A)) : (y = m.slice(0), y.splice(i, 1), y.push([o, a]), u.push(m), u.push(y))
                                }
                            return g = n(u), r(E)
                        }
                    }, r(a), d = [];
                ...
                l33t_match: function(e, t, n) {
                    ...
                    for (null == t && (t = RANKED_DICTIONARIES), null == n && (n = L33T_TABLE), c = [], _ = this.enumerate_l33t_subs(this.relevant_l33t_subtable(e, n)), u = 0, a = _.length; a > u && (d = _[u], !this.empty(d)); u++)
                        for (p = this.translate(e, d), f = this.dictionary_match(p, t), l = 0, s = f.length; s > l; l++)
                            if (o = f[l], E = e.slice(o.i, +o.j + 1 || 9e9), E.toLowerCase() !== o.matched_word) {
                                h = {};
                ...
                spatial_match_helper: function(e, t, n) {
                    ...
                    for (f = [], c = 0; c < e.length - 1;)
                        for (u = c + 1, l = null, E = 0, p = "qwerty" !== n && "dvorak" !== n || !this.SHIFTED_RX.exec(e.charAt(c)) ? 0 : 1;;) {
                            if (g = e.charAt(u - 1), o = !1, h = -1, s = -1, i = t[g] || [], u < e.length)
                                for (a = e.charAt(u), d = 0, _ = i.length; _ > d; d++)
                                    if (r = i[d], s += 1, r && -1 !== r.indexOf(a)) {
                ...
                sequence_match: function(e) {
                    ...
                    a = [];
                    for (l in SEQUENCES)
                        for (u = SEQUENCES[l], h = [1, -1], o = 0, i = h.length; i > o; o++)
                            for (t = h[o], n = 0; n < e.length;)
                                if (c = e.charAt(n), indexOf.call(u, c) < 0) n += 1;
                                else {
                ...
                regex_match: function(e, t) {
                    ...
                    null == t && (t = REGEXEN), n = [];
                    for (name in t)
                        for (r = t[name], r.lastIndex = 0; i = r.exec(e);) a = i[0], n.push({
                            pattern: "regex",
                            token: a,
                            i: i.index,
                ...
                date_match: function(e) {
                    ...
                    for (_ = [], f = /^\d{4,8}$/, d = /^(\d{1,4})([\s\/\\_.-])(\d{1,2})\2(\d{1,4})$/, s = E = 0, v = e.length - 4; v >= 0 ? v >= E : E >= v; s = v >= 0 ? ++E : --E)
                        for (o = m = I = s + 3, R = s + 7;
                            (R >= I ? R >= m : m >= R) && !(o >= e.length); o = R >= I ? ++m : --m)
                            if (O = e.slice(s, +o + 1 || 9e9), f.exec(O)) {
                    ...
                    for (s = q = 0, D = e.length - 6; D >= 0 ? D >= q : q >= D; s = D >= 0 ? ++q : --q)
                        for (o = C = S = s + 5, j = s + 9;
                            (j >= S ? j >= C : C >= j) && !(o >= e.length); o = j >= S ? ++C : --C) O = e.slice(s, +o + 1 || 9e9), b = d.exec(O), null != b && (a = this.map_ints_to_dmy([parseInt(b[1]), parseInt(b[3]), parseInt(b[4])]), null != a && _.push({
                            pattern: "date",
                            token: O,
                            i: s,
                            j: o,
                    ...
                    if (!(e[1] > 31 || e[1] <= 0)) {
                        ...
                        if (!(h >= 2 || 3 === o || g >= 2)) {
                            for (u = [
                                    [e[2], e.slice(0, 2)],
                                    [e[0], e.slice(1, 3)]
                                ], c = 0, i = u.length; i > c; c++)
                                if (_ = u[c], p = _[0], d = _[1], p >= DATE_MIN_YEAR && DATE_MAX_YEAR >= p) return t = this.map_ints_to_dm(d), null != t ? {
                                    year: p,
                                    month: t.month,
                                    day: t.day
                                } : void 0;
                            for (l = 0, a = u.length; a > l; l++)
                                if (f = u[l], p = f[0], d = f[1], t = this.map_ints_to_dm(d), null != t) return p = this.two_to_four_digit_year(p), {
                                    year: p,
                                    month: t.month,
                                    day: t.day
                                }
                ...
                map_ints_to_dm: function(e) {
                    var t, n, r, i, a, s;
                    for (a = [e, e.slice().reverse()], i = 0, n = a.length; n > i; i++)
                        if (s = a[i], t = s[0], r = s[1], t >= 1 && 31 >= t && r >= 1 && 12 >= r) return {
                            day: t,
                            month: r
                        }
                },
            ...
            adjacency_graphs = require("./adjacency_graphs"), calc_average_degree = function(e) {
                ...
                most_guessable_match_sequence: function(e, t, n) {
                    ...
                    for (null == n && (n = !1), C = [], r = [], M = 0, N = null, S = function(t) {
                        ...
                        }(this), c = A = 0, k = e.length; k >= 0 ? k > A : A > k; c = k >= 0 ? ++A : --A)
                        for (r[c] = [], C[c] = [], U = 1 / 0, G = I = 0, m = M; m >= 0 ? m >= I : I >= m; G = m >= 0 ? ++I : --I)
                            for (o = !0, a = c, 0 === G ? (s = 0, v = 1) : "bruteforce" === (null != (O = r[c - 1]) && null != (P = O[G]) ? P.pattern : void 0) ? (s = r[c - 1][G].i, v = G) : null != (null != (L = r[c - 1]) ? L[G] : void 0) ? (s = c, v = G + 1) : o = !1, o && (_ = S(s, a), T = c - _.token.length, i = this.estimate_guesses(_, e), v > 1 && (i *= C[T][v - 1]), u = D(i, v), U > u && (U = u, C[c][v] = i, N = v, M = Math.max(M, v), r[c][v] = _)), d = 0, f = t.length; f > d; d++)
                                if (R = t[d], R.j === c) {
                ...
                spatial_guesses: function(e) {
                    ...
                    for ("qwerty" === (g = e.graph) || "dvorak" === g ? (A = this.KEYBOARD_STARTING_POSITIONS, s = this.KEYBOARD_AVERAGE_DEGREE) : (A = this.KEYPAD_STARTING_POSITIONS, s = this.KEYPAD_AVERAGE_DEGREE), a = 0, t = e.token.length, R = e.turns, _ = u = 2, c = t; c >= 2 ? c >= u : u >= c; _ = c >= 2 ? ++u : --u)
                        for (h = Math.min(R, _ - 1), i = o = 1, l = h; l >= 1 ? l >= o : o >= l; i = l >= 1 ? ++o : --o) a += this.nCk(_ - 1, i - 1) * A * Math.pow(s, i);
                    if (e.shifted_count)
                        if (n = e.shifted_count, r = e.token.length - e.shifted_count, 0 === n || 0 === r) a *= 2;
                        else {
                ...
                uppercase_variations: function(e) {
                    ...
                    for (u = [this.START_UPPER, this.END_UPPER, this.ALL_UPPER], _ = 0, a = u.length; a > _; _++)
                        if (h = u[_], g.match(h)) return 2;
                    for (n = function() {
                            var e, t, n, s;
                ...
                l33t_variations: function(e) {
                    ...
                    c = 1, o = e.sub;
                    for (E in o)
                        if (g = o[E], s = e.token.toLowerCase().split(""), t = function() {
                                var e, t, n;
