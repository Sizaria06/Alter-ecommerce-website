var $ZSIQChatWindow = $ZSIQChatWindow || function() {
    ...
    return {
        ...
        constructIframe: function(e, t) {
            if ($ZSIQCookie.get("isiframeenabled") && !$ZSIQChatWindow.getChatWindowDiv() || !$ZSIQChatWindow.isTrackingOnly() || $ZSIQChat.isPreview()) {
                ...
                if (I && !_WINDOW_REPOPULATE && ($ZSIQChat.isPreview() ? r = !0 : (I.remove(), _WINDOW_REPOPULATE = !1)), r || (I && I.remove(), (I = document.createElement("DIV")).innerHTML = '<div id="siqcht" class="zls-prelative" ><iframe id="siqiframe" title="SalesIQ Chatwindow" seamless="seamless" height="460" width="100%" scrolling="no"></iframe></div>', I.style.visibility = "hidden"), I.className = function() {
                        ...
                        t += $ZSIQChat.isPreview() ? "" : "zsiq-mobhgt ", t += $ZSIQChatWindow.isNewHeader() ? "zsiq-newtheme " : "";
                        var i = " zsiq_size" + $ZSIQWidget.getEmbedSize();
                        return $ZSIQChat.isSignatureChat() ? t + i : ($ZSIQChat.isSeasonalTheme() && (t += " zsiqseasonal "), t + c[$ZSIQWidgetUI.getWidgetPosition()] + i)
                    }(), I.setAttribute("embedtheme", o.theme), I.setAttribute("data-id", "zsiqembed"), r) $ZSIQUtil.getIframe().$Support.init($ZSIQWidget.getEmbedObject());
                else if (i = $ZSIQChat.getWidgetData().embedobj.einfo.embedid, a = ($ZSIQLSDB.get("ZLD" + i) || {}).ongoingchats || {}, s = 0 !== Object.keys(a).length, $ZSIQLSDB.get("ZLDTRIGGER" + i) || $ZSIQLSDB.get("ZLD" + i + "WAITING") || s || $ZSIQChat.isPreview() || t || 0 == $zohosq.fileloadtime) $ZSIQChatWindow.populateIframe(t);
                else {
                    var l = o.widget_performance_optimised ? 15e3 : $zohosq.postloadtime || 1e4;
                    ...
                    i ? $ZSIQChatWindow.handleChatWindowVisible(i, e) : $ZSIQWidgetUI.getWidgetState() != $ZSIQWidgetUI.F_WINDOW ? m() : ($ZSIQChatWindow.populateIframe(), g(!0))
            ...
            if (!document.getElementById("siqiframe")) {
                ! function() {
                    ...
                    if (iscdnenabled && !$ZSIQChat.isPreview()) {
                        var t = $zohosq.nonce,
                            i = {};
                        i[SIQ_FLOAT] = "/salesiq/styles/floatbuttonpostload_f1220b7c9b22ce1312e9acd2dd6c3f30_.css", i[SIQ_BUTTON] = "/salesiq/styles/buttonthemepostload_74b40777ef0e489d681c4a1870479f46_.css", i[SIQ_PERSONALIZE] = "/salesiq/styles/personalizethemepostload_74b40777ef0e489d681c4a1870479f46_.css";
                        var a = e.widgetobj,
                ...
                }(), clearTimeout(d), document.body.appendChild(I), (0 == $zohosq.fileloadtime || i) && o();
                ...
                e.onload = function() {
                    ...
                    e.handleStatusCallback(), e.handleAudioCallback(),
                        ...
                        }(), t && t(), I.className = I.className.replace(/(?:^|\s)siq_showload(?!\S)/, ""), i && i(), $ZSIQUtil.startOnLoad(), $ZSIQUtil.idetifyVisitorData(), e.Util && e.Util.loadExternalFiles()
                };
                var a = (e.contentWindow || e.contentDocument.document || e.contentDocument).document;
                a.open(), a.write($ZSIQChatWindow.getFiles()), a.close()
            }
        },
        ...
        openChatWindow: function(e, t) {
            ...
            I.hasAttribute("drag") || (I.style.top = ""), $ZSIQWidgetUI.isCSSTransformSupported() ? (g(!0), $ZSIQUTSAction.widget_interaction && (o(), $ZSIQChatWindow.triggerloader = setTimeout(function() {
                $ZSIQChatWindow.RemoveLoadingForTrigger()
            }, 2e3))) : I.style.display = "block";
            var i = $ZSIQWidgetUI.getWidgetDiv();
            try {
                var a = $ZSIQWidgetUI.getMinWidgetDiv();
            ...
            if ($ZSIQWidget.handleCallBacks({
                ...
                s.getUnreadCount() && !s.isConversationUIFocussed() && (s.removeUnreadCookie(), $ZSIQWidgetUI.removeUnreadCount()), $ZSIQUtil.getIframe().$UI && !$ZSIQChat.isPreview() && setTimeout(function() {
        ...
        expandChatWindow: function() {
            ...
            "-10000px" == I.style.top && (I.style.top = ""), $ZSIQWidgetUI.isCSSTransformSupported() ? g(!0) : I.style.display = "block", $ZSIQWidgetUI.setWidgetState($ZSIQWidgetUI.F_WINDOW)
        },
        closeChatWindow: function(e) {
            $ZSIQUtil.stopBlinking(), e || $ZSIQWidget.handleCallBacks({
                "chat.close": ""
            }), g(), I.className = I.className.replace(/(?:^|\s)remtrans(?!\S)/, "");
            try {
                var t = $ZSIQUtil.getAPIValues(),
        ...
        handleChatWindowVisible: function(e, t, i, a) {
        ...
        handleDrag: function(e) {
            ...
            return cx = t.offsetLeft - parseInt(i[0]), cy = t.offsetTop - parseInt(i[1]), cx = cx < 0 ? 0 : cx, cy = cy < 0 ? 0 : cy, cx = cx + s > o ? o - s : cx, cy = cy + n > r ? r - n : cy, t.style.left = cx + "px", t.style.top = cy + "px", t.style.right = "auto", !(t.style.bottom = "auto")
        },
        ...
        getFiles: function() {
            var e, t = $ZSIQWidget.getEmbedObject(),
                i = $ZSIQWidget.getWidgetObject(),
                a = $ZSIQChat.getWidgetData().commondata,
                s = "";
            ($ZSIQChat.isPreview() || $ZSIQChat.isSignatureChat()) && (s = "skipdrag");
            var n = a.schema + "://" + t.embedserverurl,
                o = "",
                r = "";
            try {
            ...
            if (iscdnenabled && (i.cssstaticfile = "/salesiq/styles/embedtheme" + t.theme + "_" + cssjslist[i.cssstaticfile] + "_.css", i.jsstaticfile = "/salesiq/js/siqchatwindow" + t.theme + "_" + cssjslist[i.jsstaticfile] + "_.js"), $ZSIQChatWindow.isNewHeader()) {
                var c = t.jquery_version_updated;
                i.cssstaticfile = "/salesiq/styles/newembedtheme_ac831ffd8a13244c387f8c39805eb846_.css", i.jsstaticfile = c ? "/salesiq/js/siqnewchatwindow1_a0c911dbc97dd7392c15b811086fc64b_.js" : "/salesiq/js/siqnewchatwindow_25f8de082bb85aa96c3fb41ce20b81d0_.js"
            }
            if ($ZSIQChat.isPreview() && !d) {
                var I = /(?:settings\/)(?:apps|brands|triggers)/.test(parent.window.location.href),
                    g = t.ucomp ? a.jscdnstaticserver + "/salesiq/js/chatwindowpreview_444d611d99aafaf75ff75de65248c133_.js" : n + "/js/embed/new/chatwindow/chatwindowpreview.js",
                    m = I ? "" : t.ucomp ? i.csscdnstaticserver + "/salesiq/styles/chatwindowpreview_46eaf2430cc94e4578f095a688287005_.css" : n + "/styles/embed/new/chatwindow/chatwindowpreview.css";
                o = I ? "" : '<link href="' + m + '" rel="stylesheet" type="text/css" />', o += '<script src="' + g + '"><\/script>'
            }
            if (t.ucomp) {
                var S = $zohosq.nonce ? 'nonce ="' + $zohosq.nonce + '"' : "",
                    h = a.jscdnstaticserver + "/salesiq/js/embedmedia-rtc_428e461898cb60baa74cb3c013030421_.js";
                e = '<html><head><link href="' + i.csscdnstaticserver + i.cssstaticfile + '" rel="stylesheet" ' + S + ' type="text/css" onerror="' + r + '" />', a.isrtlsupported && (e += '<link href="' + i.csscdnstaticserver + '/salesiq/styles/embedrtl_d41d8cd98f00b204e9800998ecf8427e_.css" rel="stylesheet" ' + S + ' type="text/css" />'), e += '<script src="' + i.wmsjsstaticserver + '" ' + S + ' ><\/script><script src="' + a.jscdnstaticserver + i.jsstaticfile + '" ' + S + ' ><\/script><script src="' + l + '"  onerror="' + r + '" ' + S + " ><\/script>" + o + "</head><body></body></html>", t.einfo.embedstatus.staticfiles_delayloading_enabled || (e += '<script src="' + h + '" ' + S + " ><\/script>")
            } else {
                t.theme, t.theme, t.theme;
                $ZSIQChatWindow.isNewHeader() && ("themeui.js", "themetemplate.js", "theme.css", "themecommon.css"), e = Filedatagetter.getIframeFileData({
                    iframecls: s,
                    preview_files: o
                })
            }
            try {
                var p = JSON.parse(t.einfo.props.iscustomcss);
                if (1 == p[0] && p[1].fpath) {
                    var f = p[1].fpath;
                    if ("undefined" != typeof $ZSIQChat && $ZSIQChat.getWidgetData().usedownloadserver) {
                        var u = f.split("/")[1],
                            $ = $ZSIQWidget.getEmbedObject().pinfo.soid,
                            Q = p[1].fname ? p[1].fname : p[1].pfname;
                        Q = Q || "customcss.css";
                        var Z = {
                            "x-siq-filetype": f.split("/")[0],
                            "x-siq-lsid": u.split("_")[1],
                            "x-siq-soid": $,
                            "x-siq-ispreview": !1,
                            "x-siq-pfname": Q
                        };
                        e += '<link href="' + UDHandler.getDownLoadLink(u, "default", Z) + '" rel="stylesheet" type="text/css" />'
                    } else e += '<link href="' + n + "/" + t.screenname + "/" + f + '/stylesheet.ls" rel="stylesheet" type="text/css" />'
                }
            } catch (e) {}
            return e
        },
            ...
            if (e) {
                ...
                if (t) {
                    var i = $ZSIQWidget.getWidgetObject(),
                        ...
                        s = e[1];
                    s[a + ".html"] && (t.innerHTML = s[a + ".html"]), $ZSIQUtil.bindClickEvent(t, function() {
...
var $ZSIQWidgetUI = $ZSIQWidgetUI || function() {
    var I, t, g, s, r, m = {
        ...
        n = function(e) {
            var t = $ZSIQUtil.getAPIValues(),
                i = $ZSIQWidget.getWidgetObject(),
                n = !0 === i.status ? "online" : "offline",
                a = ("maintitle" == e ? i.title[1][n] : i.title[1][n + "_byline"]) || i.i18nkeys["float." + n + "." + e],
                l = "maintitle" == e ? 0 : 1,
                s = t.buttontexts;
            return s && (i.status && s[0] ? a = s[0][l] || a : !i.status && s[1] && (a = s[1][l] || a)), $ZSIQUtil.getEncodedText(a)
        },
        S = function(e) {
    ...
    return {
        ...
        drawWidget: function() {
            var e = $ZSIQWidget.getWidgetObject(),
                ...
                i = m[$ZSIQWidgetUI.getWidgetPosition()],
                n = !!g;
            if (n || (g = document.createElement("DIV")), g.className = f(e) + i, g.innerHTML = S(function(e) {
                    if (e.sticker[0] != $ZSIQUtil.STATUS_DISABLE) return g.style.height = "", g.style.width = "", I = $ZSIQTemplate["theme" + e.sticker[1].default], e.clogo_src = $ZSIQUtil.getCompanyLogo(e.clogo_src), I.getFloatStickerHTML(e);
                    var t = e.status ? "online" : "offline";
                    return e.sticker[1] && e.sticker[1].online ? c(e, t) : '<div id="zsiq_float" class="zsiq_float zsiq_empty"><div class="zsiq_flt_rel"></div></div>'
                }(e)), g.setAttribute && g.setAttribute("data-id", "zsalesiq"), n || (g.style.visibility = "hidden", document.body.appendChild(g)), !$ZSIQChat.isPreview()) {
                var a = t.pinfo.pinfo,
        ...
        minimizeSticker: function(e, t) {
            if (!$ZSIQChat.isPreview()) {
                ...
                if (i.sticker[0] != $ZSIQUtil.STATUS_DISABLE && (d = s, -1 < u.indexOf("" + d))) {
                    var d;
                    if ("1" == s) {
                        ...
                        g.innerHTML = S(I.getFloatButtonHTML($ZSIQWidget.getWidgetObject())), g.className = f(i) + m[$ZSIQWidgetUI.getWidgetPosition()], $ZSIQUtil.bindClickEvent(g, $ZSIQChatWindow.openChatWindow), e && $ZSIQWidgetUI.addClass(g, "zsiqfanim"),
                            function() {
        ...
        handleFloatEvents: function(e) {
            if ("siqico-close" != e.target.getAttribute("class"))
                if ("minsticker" != e.target.getAttribute("data-click")) {
                    var t = $ZSIQUtil.getIframe();
                    if (t) {
                        if (!$ZSIQChat.isPreview() && t.$Support && (s == $ZSIQWidgetUI.F_BUTTON || s == $ZSIQWidgetUI.F_STICKER)) {
                            var i = t.$Support.Util;
                            i.ispostloaddone || (clearTimeout(i.jsdownloadtimer), i.downloadAdditionalFiles()), $ZSIQChatWindow.openChatWindow()
                        }
        ...
        checkWidgetVisibility: function(e) {
            ...
            if (!i || $ZSIQChat.isPreview() || "hide" != i && "show" != i && isNaN(i))
                if ("1" == t.mdevice_hide[0] && $ZSIQWidgetUI.isHandHeldDevice()) g.style.display = "none";
                    ...
                    if ("1" == t.hideoffline[0] && !t.status || 0 == t.islivechat || t.hideembed) {
        ...
        bindCustomCSS: function(e) {
            ...
            a.id = "zsiqcustomcss", a.setAttribute && a.setAttribute("data-id", "zsalesiq"), a.appendChild(document.createTextNode(i.getCustomCSS(e))), document.body.appendChild(a)
        },
